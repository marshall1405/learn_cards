...
The plan is to write an application that would be similar to quizlet. Basically learning card sets that would allow you to learn theory quickly. I also want to put this application on a Raspberry Pi and make it a portable learning gadget.
